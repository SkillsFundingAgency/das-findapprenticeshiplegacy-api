...
namespace SFA.DAS.FAA.Legacy.Application.User.Queries
{
    public class GetUserByEmailResult
    {
        ...
        public ApplicationTemplate? ApplicationTemplate { get; init; }

        public CommunicationPreferences? CommunicationPreferences { get; init; }

        public HelpPreferences? HelpPreferences { get; init; }

        public MonitoringInformation? MonitoringInformation { get; init; }
    }
}
